...
<iframe src="https://www.nicky.photos/frame/slideshow?key=PcvPnm&speed=1&transition=fade&autoStart=1&captions=0&navigation=1&playButton=0&randomize=0&transitionSpeed=1" class="w-full" height="600" frameborder="no" scrolling="no"></iframe>
...
### Layout, Permitting
todo: image here from hand drawn sketch. 
...
`April 26, 2024`: Plans were approved on the first try!
